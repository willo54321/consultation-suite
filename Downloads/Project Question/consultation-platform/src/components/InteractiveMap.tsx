...
import { GoogleMap, useJsApiLoader, MarkerF, InfoWindowF, PolygonF, PolylineF, DrawingManagerF, RectangleF, OverlayView } from '@react-google-maps/api'
...
const InteractiveMap = forwardRef<InteractiveMapRef, InteractiveMapProps>(({
  ...
  // Use EXACT same loader config as working EmbedMap
  ...
  // onLoad - Follow EmbedMap pattern exactly
  ...
  // Convert GeoJSON to Google paths
